...
[test data](https://d396qusza40orc.cloudfront.net/predmachlearn/pml-testing.csv) were loaded into the working directory.
...
```{r partion data}
require(caret)
inTrain <- createDataPartition(y=df.train$classe, p=.6, list=FALSE)
...
With an accuracy of more than 99.2% (i.e. an **expected out of sample error** of **less than 0.8%**) I am sure enough that a prediction for our 20 test cases is OK for submitting.
